...
public class ContextProps extends ExpressionProps {
    ...
    public ContextProps(final String uid, final String name, final String dataType, final ContextEntryProps[] contextEntries, final ExpressionProps result, final Double entryInfoWidth, final Double entryExpressionWidth) {
        super(uid, name, dataType, CONTEXT.getText());
